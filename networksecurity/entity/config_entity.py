...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config: TrainingPipelineConfig):
        ...
        self.expected_accuracy: float=training_pipeline.MODEL_TRAINER_EXPECTED_SCORE_FILE
        self.overfitting_underfitting_threshhold = training_pipeline.MODEL_TRAINER_OVER_FITTING_UNDER_FITTING_THRESHOLD
